...
PROCESS_INPUT_SPECS: tuple[DiagramInputSpec, ...] = (
    DiagramInputSpec("exhaust_mass_flow", "Exhaust flow", "mass_flow", "kg/s", "exhaust_mass_flow", 20, 24, "#de2f2f"),
    DiagramInputSpec("exhaust_inlet_temp", "Exhaust Tin", "temperature", "degC", "exhaust_inlet_temp", 20, 102, "#de2f2f"),
    DiagramInputSpec("exhaust_pressure", "Exhaust P", "pressure", "kPa", "exhaust_pressure", 20, 180, "#de2f2f"),
    DiagramInputSpec("exhaust_outlet_temp", "Stack Tout", "temperature", "degC", "exhaust_outlet_temp", 20, 258, "#de2f2f", "exhaust_outlet_enabled"),
    DiagramInputSpec("stack_min_temp", "Min stack", "temperature", "degC", "stack_min_temp", 20, 336, "#de2f2f"),
    DiagramInputSpec("oil_mass_flow", "Oil flow", "mass_flow", "kg/s", "oil_mass_flow", 430, 18, "#6a39a8"),
    DiagramInputSpec("wf_max_outlet_temp", "WF Tmax", "temperature", "degC", "wf_max_outlet_temp", 826, 18, "#f1b400"),
    DiagramInputSpec("eta_orc_gross", "Gross eta", "ratio", "%", "eta_orc_gross", 1460, 24, "#134f95", "orc_efficiency_enabled"),
    DiagramInputSpec("gross_power_target", "Pgross target", "power", "kW", "gross_power_target", 1460, 102, "#134f95", "gross_power_target_enabled"),
    DiagramInputSpec("closure_tolerance", "Closure tol", "ratio", "%", "closure_tolerance", 1460, 180, "#134f95"),
    DiagramInputSpec("oil_outlet_temp", "Boiler oil out", "temperature", "degC", "oil_outlet_temp", 420, 660, "#6a39a8", "oil_outlet_enabled"),
    DiagramInputSpec("oil_inlet_temp", "Oil return", "temperature", "degC", "oil_inlet_temp", 420, 742, "#6a39a8"),
    DiagramInputSpec("loop_target_delivery_temp", "Oil to ORC", "temperature", "degC", "loop_target_delivery_temp", 652, 660, "#6a39a8", "loop_target_delivery_enabled"),
    DiagramInputSpec("loop_heat_loss", "Loop loss", "power", "kW", "loop_heat_loss", 652, 742, "#6a39a8", "loop_heat_loss_enabled"),
    DiagramInputSpec("orc_min_approach", "Min approach", "delta_t", "K", "orc_min_approach", 904, 660, "#f1b400"),
    DiagramInputSpec("wf_inlet_temp", "WF Tin", "temperature", "degC", "wf_inlet_temp", 904, 742, "#f1b400"),
    DiagramInputSpec("orc_target_wf_outlet", "WF Tout target", "temperature", "degC", "orc_target_wf_outlet", 1156, 660, "#f1b400", "orc_target_wf_outlet_enabled"),
    DiagramInputSpec("orc_known_heat_input", "ORC Qin", "power", "kW", "orc_known_heat_input", 1156, 742, "#f1b400", "orc_known_heat_input_enabled"),
)
